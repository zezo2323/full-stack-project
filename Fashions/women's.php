  ...
  <nav class="bottom-nav">
    ...
    <section class="slider">
        <div class="container">
            <h2>Filters</h2>
            <div class="box">
                <div class="arrow-left"><a href="../Fashion.php"><i class="fa-solid fa-arrow-left"></i></a></div>
                <h5>Fashions</h5>
                <h3>Category</h3>
...
<?php
    $badgeQuery  = "SELECT * FROM product_badges WHERE badge_id = " . $product['badge_id'];
        ...
        ?>
                                    <div class="product__badge <?php echo $badge['badge_text'] === 'Sale' ? 'sale-badge' : 'new-badge'?>">

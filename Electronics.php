...
// الحصول على الفئة "Electronics" (افترض أن category_id = 1)
$category_id = 1;
                    ...
                    <div class="product__item">
                        <div class="product__banner">
                            ...
                            <div class="product__actions">
                                <button class="action__btn quick-view" data-id="<?= $product['product_id'] ?>" aria-label="Quick View">
                                    <i class="fi fi-rr-eye"></i>
                                </button>
                                <button class="action__btn add-wishlist" data-id="<?= $product['product_id'] ?>" aria-label="Add To Wishlist">
                                    <i class="fi fi-rr-heart"></i>
                                </button>
                                <button class="action__btn compare" data-id="<?= $product['product_id'] ?>" aria-label="Compare">
                        ...
                        <div class="product__content">
                            ...
                            <button class="action__btn cart__btn add-to-cart" 

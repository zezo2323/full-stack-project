...
<body>
  ...
  <nav class="bottom-nav">
            ...
            <div class="box">
                ...
                <ul class="category-list">
                    <ul class="category">
                        ...
                        <a href="./Fashions/men's.php"><span>Men's Wear</span></a>
                        ...
                        <li class="has-submenu">
                        <a href="./Fashions/women's.php"><span>Women's Wear</span></a>
                            <span class="arrow">▶</span>
                            <ul class="subcategory">
                                <li><a href="#">T-Shirts</a></li>
                                <li><a href="#">Pants</a></li>
                        ...
                        <li class="has-submenu">
                        <a href="./Fashions/kids.php"><span>Kids Wear</span></a>
                            <span class="arrow">▶</span>
                            <ul class="subcategory">
                                <li><a href="#">T-Shirts</a></li>
                                <li><a href="#">Pants</a></li>
    ...
    <section class="products-container">
        ...
        <!-- banners -->
        <div class="banners">
            <a href="./Fashions/men's.php"><img src="./imgs/Fashions/Fashions/banner2.jpg" alt="banner"></a>

        </div>
        <!-- posters -->
        <div class="posters">
            <a href="./Fashions/men's.php"><img src="./imgs/Fashions/Fashions/poster1.jpg"
                    alt="poster"></a>
            <a href="./Fashions/men's.php"><img src="./imgs/Fashions/Fashions/poster3.jpg" alt="poster"></a>
        </div>
        <div class="banners">
            <a href="./Fashions/women's.php"><img src="./imgs/Fashions/Fashions/banner3.jpg" alt="banner"></a>
        </div>
        <hr>

            ...
            <div class="box">
                ...
                <ul class="category-list">
                    <ul class="category">
                        ...
                        <li class="has-submenu">
                            <a href="./Vehicles/motors.php"><span>Motorcycle<i class="fa-solid fa-motorcycle"></i></span></a>
                            <span class="arrow">▶</span>
                            <ul class="subcategory">
                        ...
                        <li class="has-submenu">
                            <a href="./Vehicles/bicycles.php"><span>Bicycles <i class="fa-solid fa-bicycle"></i></span></a>
                            <span class="arrow">▶</span>
                            <ul class="subcategory">
                                <li><a href="#">3T</a></li>
                                <li><a href="#">6KU</a></li>

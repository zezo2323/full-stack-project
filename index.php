    ...
    <section class="categories container section">
      ...
      <div class="categories__container swiper">
        <div class="swiper-wrapper">
          ...
          <a href="./vehicles/cars.php" class="category__item swiper-slide">
          ...
          <a href="./Electronics/Computers.php" class="category__item swiper-slide">
          ...
          <a href="./home catagory/Electrical appliances.php" class="category__item swiper-slide">
            <img src="./imgs/index/Appliances.jpg" alt="" class="category__img" />
            <h3 class="category__title">Appliances</h3>
          </a>
          <a href="./Electronics/Smart_phones.php" class="category__item swiper-slide">
          ...
          <a href="./Fashion.php" class="category__item swiper-slide">
...
");
    ...
    ?>
    <section class="new-arrivals container section" id="NewArrivals">
              ...
              <div class="col-6 col-md-3">
                ...
                <ul class="list-unstyled">
                  <li class="mb-3 d-flex align-items-center gap-2">
                    ...
                    <span class="inf">voyx@gmail.com</span>
                  </li>
                  <li class="mb-3 d-flex align-items-center gap-2">
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        searchInput.addEventListener('input', function() {
            ...
            debounceTimer = setTimeout(() => {
                // محاكاة الاقتراحات (يمكن استبدالها بطلب AJAX حقيقي)
